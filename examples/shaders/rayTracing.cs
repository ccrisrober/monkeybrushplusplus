...
// Code based on https://www.shadertoy.com/view/4ljGRd
...
Intersect trace(Ray ray) {
    ...
    spheres[1] = Sphere(3.0, vec3( 4.0 + cos(time), 3.0, 0), Material(vec3(0.0, 0.2, 1.0), 1.0, 0.0));
...
void main () {
  ...
  vec2 myuv = vec2(u, v) - vec2(0.5);

  Ray ray = Ray(vec3(0.0, 2.5, 12.0), normalize(vec3(myuv.x, myuv.y, -1.0)));
