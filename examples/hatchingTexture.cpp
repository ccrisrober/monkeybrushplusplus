...
int main(void)
{
  mb::GLContext context( 3, 3, 1024, 768, "Hatching Texture" );
  ...
  std::string fragmentShader = mb::os::readFile( MB_SHADER_FILES + std::string( "/hatchingFrag.glsl" ) );
  ...
  mb::ShaderMaterialPtr material = std::make_shared<mb::ShaderMaterial>(
    "hatchingMaterial", shaders, uniforms );
