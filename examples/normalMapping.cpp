...
{
  mb::TexOptions opts;
  mb::TexturePtr texDiffuse = std::make_shared<mb::Texture2D>( opts,
    MB_TEXTURE_ASSETS + std::string( "/chesterfieldDiffuseMap.png" ) );
  mb::TexturePtr texNormal = std::make_shared<mb::Texture2D>( opts,
    MB_TEXTURE_ASSETS + std::string( "/chesterfieldNormalMap.png" ) );
  mb::TextureCache::add( "chesterDiffuse", texDiffuse );
  mb::TextureCache::add( "chesterNormal", texNormal );
}
...
int main(void)
{
  ...
  mb::DrawablePtr model = std::make_shared<mb::Cube>( 2.0f );
  ...
  std::vector<std::pair<const char*, mb::Uniform*> > uniforms = {
    ...
    std::make_pair( "texDiffuse", new mb::Uniform( mb::TextureSampler, mb::TextureCache::get( "chesterDiffuse" ) ) ),
    std::make_pair( "texNormal", new mb::Uniform( mb::TextureSampler, mb::TextureCache::get( "chesterNormal" ) ) ),
  };

  mb::ShaderMaterialPtr material = std::make_shared<mb::ShaderMaterial>(
    "normalMappin", shaders, uniforms );
  ...
  mbNode->addComponent( std::make_shared<NormalController>( normalScale ) );
