...
void loadResources( void )
{
  ...
  mb::TexturePtr tex2 = std::make_shared<mb::Texture2D>( opts,
    MB_TEXTURE_ASSETS + std::string( "/3_no_ice_clouds_8k.jpg" ) );
  mb::TextureCache::add( "texHeightmap", tex2 );
}
...
int main( void )
{
  ...
  mb::DrawablePtr plane = std::make_shared<mb::Plane>( 26.0f, 20.0f, 50, 50 );
  ...
  std::vector<std::pair<const char*, mb::Uniform*> > uniforms =
  {
    ...
    std::make_pair( "texHeightmap", new mb::Uniform( mb::TextureSampler, mb::TextureCache::get( "texHeightmap" ) ) ),
    std::make_pair( "texDiffuse", new mb::Uniform( mb::TextureSampler, mb::TextureCache::get( "texDiffuse" ) ) )
  };

  mb::ShaderMaterialPtr material = std::make_shared<mb::ShaderMaterial>(
    "heightmapTesselation", shaders, uniforms );
  material->Cull = false;
