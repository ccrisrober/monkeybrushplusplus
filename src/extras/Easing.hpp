...
namespace MB
{
	namespace Easing
	{
        ...
        namespace sine
        {
            ...
            {
                return 1.0f + std::sin(PI_2 * (t - 1.0f));
            }
            /**
            ...
            {
                return 0.5f * (1.0f + std::sin(PI * (t - 0.5f)));
            }
        }
        ...
        namespace elastic
        {
            ...
            float easeOut(float& t)
            {
                ...
                return 1.0f - t2 * t2 * std::cos(t * PI * 4.5f);
            }
            /**
             * Easing equation for an elastic (exponentially decaying
            ...
            float easeInOut(float& t)
            {
                ...
                if (t < 0.45) {
                    t2 = t * t;
                    return 8.0f * t2 * t2 * std::sin(t * PI * 9.0f);
                } else if (t < 0.5f) {
                    return 0.5f + 0.75 * std::sin(t * PI * 4.0f);
                } else {
                    t2 = (t - 1.0f) * (t - 1.0f);
                    return 1.0f - 8.0f * t2 * t2 * std::sin(t * PI * 9.0f);
                }
            }
        }
        ...
        namespace bounce
        {
            ...
            {
                if (t < 0.5f) {
                    return 8.0f * std::pow(2.0f, 8.0f * (t - 1.0f)) * std::abs(std::sin(t * PI * 7.0f));
                } else {
